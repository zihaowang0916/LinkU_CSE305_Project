...
<body background="image/heart.png">
	...
	session.setAttribute("UA", PF1);
	session.setAttribute("UB", PF2);
	
	%>
<form action="user_refe_result.jsp" method="post">
            <div align="center" >
                <ul >
                    
                   <li style="list-style-type:none;float: top;"><h2>Who are you referring?</h2></li>
                        
                  
                     <li style="list-style-type:none;float:top;margin-top: 10px">
                    
                        <input type="text" name="UC" placeholder="Your friend's profile id" style="height: 40px;">
                    </li>
