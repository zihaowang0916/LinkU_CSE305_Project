...
<title>most active profile</title>
<style>
table, th, td{
 margin: 0 auto;
 font-size: 14px;
...
<body background="image/heart.png">
	...
	<h2 align="center">the most active profile</h2>
	<div align="center">
	<table align="center" border="1"
				style="background-color: #FFC0CB;">
				<tr>
					<td align="center">Profile id</td>
					<td align="center">Last modified time</td>
	...
	session.setAttribute("finalid",UserIdd);
		...
		String s = "SELECT ProfileID,LastModDate FROM ProfileData P WHERE P.LastModDate = (SELECT MAX(LastModDate) FROM ProfileData);";
		...
		String pfid = rs.getString("ProfileID");
