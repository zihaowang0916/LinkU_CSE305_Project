...
<html>
<head>
<title>accept your suggested date</title>
	...
	String mysPassword = "8812992";
		...
		try {
			...
			//connect to the database
				...
				sql = "insert into DateData(Profile1,Profile2,CustRep,Time,GeoLocation,BookingFee,U1Rated,U2Rated,Comments,IsGeoDate) values('"+p1+"','"+p2+"','"+request.getParameter("CR")+"','"+currDate+"','NULL','0','3','3','NULL','0')";
