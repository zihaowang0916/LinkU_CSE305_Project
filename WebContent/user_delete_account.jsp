	...
	String mysPassword = "8812992";
		...
		try {
			...
			//connect to the database
				...
				String sql = "DELETE FROM AccountTable " +" WHERE UserId = '" + request.getParameter("ID") + "' and CreditCardNum='" + request.getParameter("CN")  + "'  and AccountNum='" + request.getParameter("AN")  + "'";
