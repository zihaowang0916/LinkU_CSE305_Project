	...
	String mysPassword = "8812992";
		...
		try {
			...
			//connect to the database
				...
				String sql = "DELETE FROM DateData WHERE Profile1 = '" + request.getParameter("PF1") + "' and Profile2='" + request.getParameter("PF2")  + "'  and Time='" + request.getParameter("T")  + "'";
