        ...
        java.sql.Connection conn=null;
				...
				//connect to the database
            		...
            		java.sql.Statement stmt1=conn.createStatement();
                       ...
                       java.sql.ResultSet rs = stmt1.executeQuery("select * from employer where email='"+request.getParameter("comp-email")+"'");
			...
			stmt1.executeUpdate("INSERT INTO employer (email, phone, about, name, ceo, password, location) VALUES("
                                + "'"+request.getParameter("comp-email")+"','"+request.getParameter("comp-phone")+"',"
                                        + "'"+request.getParameter("comp-about")+"','"+request.getParameter("comp-name")+"',"
                                                + "'"+request.getParameter("ceo")+"','"+request.getParameter("comp-password")+"',"
                                                        + "'null')");
